...
namespace DoYouEvenLiftBro.DAL.Migrations
{
    ...
    [Migration("20181124023509_ChangedMuscleGroupsToPrimaryMuscleGroup")]
    partial class ChangedMuscleGroupsToPrimaryMuscleGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoYouEvenLiftBro.DAL.Entities.Rep", b =>
                {
                    ...
                    b.Property<long?>("RepTypeId")
                        .HasColumnName("rep_type_id");
                    ...
                    b.HasIndex("RepTypeId")
                        .HasName("ix_reps_rep_type_id");
            ...
            modelBuilder.Entity("DoYouEvenLiftBro.DAL.Entities.Rep", b =>
                {
                    b.HasOne("DoYouEvenLiftBro.DAL.Entities.RepType", "RepType")
                        .WithMany()
                        .HasForeignKey("RepTypeId")
                        .HasConstraintName("fk_reps_rep_types_rep_type_id");
            ...
            modelBuilder.Entity("DoYouEvenLiftBro.DAL.Entities.RepType", b =>
                {
                    b.HasOne("DoYouEvenLiftBro.DAL.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_rep_types_asp_net_users_user_id");
                });
