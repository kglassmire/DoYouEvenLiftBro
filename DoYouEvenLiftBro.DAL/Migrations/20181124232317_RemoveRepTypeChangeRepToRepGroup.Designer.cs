...
namespace DoYouEvenLiftBro.DAL.Migrations
{
    ...
    [Migration("20181124232317_RemoveRepTypeChangeRepToRepGroup")]
    partial class RemoveRepTypeChangeRepToRepGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoYouEvenLiftBro.DAL.Entities.RepGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_rep_group");

                    b.HasIndex("SetId")
                        .HasName("ix_rep_group_set_id");
            ...
            modelBuilder.Entity("DoYouEvenLiftBro.DAL.Entities.RepGroup", b =>
                {
                    b.HasOne("DoYouEvenLiftBro.DAL.Entities.Set", "Set")
                        .WithMany("RepGroups")
                        .HasForeignKey("SetId")
                        .HasConstraintName("fk_rep_group_sets_set_id");
                });
